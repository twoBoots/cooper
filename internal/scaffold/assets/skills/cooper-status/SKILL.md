...
- **Native File Tools Mandate:** Always use dedicated file tools (`view_file`, `write_to_file`, `replace_file_content`) to read or inspect files. Do NOT use shell pipes or redirections.
