# Spec Delta: Documentation Review Refinements
...
- AND it MUST specify that agents act as a principal engineer when conducting quality reviews before opening or merging a PR.
