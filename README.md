...
**Cooper** combines the **Conductor** ([conductor](https://github.com/twoBoots/conductor)) methodology with worktree isolation via **Troop** ([troop](https://github.com/twoBoots/troop)) for crafting a barrel of monkeys (i.e. human and AI developers working in trees).
